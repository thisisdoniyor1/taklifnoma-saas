      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
           <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
              ...
              <p className="text-sm font-extrabold text-slate-900">{date || '15 June, 2026'}</p>
        ...
        <div className="space-y-4">
           <button className="w-full h-16 bg-slate-950 text-white rounded-2xl flex items-center justify-center gap-3 text-[11px] font-bold uppercase tracking-[3px] hover:bg-cyan-500 transition-all shadow-2xl shadow-slate-950/20 group">
              <Navigation size={18} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
              Get Location
           </button>
           <button className="w-full h-16 bg-white border border-slate-200 text-slate-900 rounded-2xl flex items-center justify-center gap-3 text-[11px] font-bold uppercase tracking-[3px] hover:border-cyan-500 transition-all transition-colors group">
